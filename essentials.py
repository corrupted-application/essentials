...
import os
if os.name == 'nt':
  import winsound # fix for POSIX systems, would result in hang due to winsound being loaded, which is not available on POSIX systems
...
def version():
  print("[essentials]: Essentials 0.0.3.2")
